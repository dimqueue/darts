...
export const LANGUAGES_WITH_ALL = [{ code: '', name: 'All Languages', flag: '🌐' }, ...LANGUAGES];
...
export const GAME = {
    ...
    MAX_WORD_LENGTH: 50,
    DISTANCE_THRESHOLDS: {
        VERY_CLOSE: 100, // Green
        CLOSE: 500, // Yellow-green
        MEDIUM: 1000, // Yellow
        FAR: 5000, // Orange
        // > 5000 = Red
    },
...
export const ERROR_MESSAGES = {
    ...
    [ERROR_CODES.WORD_TOO_FAR]: 'This word is too far from the target.',
